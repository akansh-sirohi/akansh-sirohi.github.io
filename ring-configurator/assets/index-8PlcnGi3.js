...
`;let _n,Kn,dn,Ba,ki,Wi,za;function Ll(i,t){return new Promise((e,n)=>{new lf().load(t,r=>{r.mapping=ws;const o=new eu(r.image.height,{format:Wa,generateMipmaps:!0,minFilter:Pn});o.fromEquirectangularTexture(i,r),e(o.texture)},void 0,r=>n(r))})}const L0=new hu;let on,Il,Su;const Xn={bounces:3,ior:2.4,correctMips:!0,chromaticAberration:!0,aberrationStrength:.01,color:16777215,diamondShape:"round"},I0={asscher:"./assets/all_diamonds/asscher.obj",cushion:"./assets/all_diamonds/cushion.obj",emerald:"./assets/all_diamonds/emerald.obj",heart:"./assets/all_diamonds/heart.obj",marquise:"./assets/all_diamonds/marquise.obj",oval:"./assets/all_diamonds/oval.obj",pear:"./assets/all_diamonds/pear.obj",princess:"./assets/all_diamonds/princess.obj",radiant:"./assets/all_diamonds/radiant.obj",round:"./assets/all_diamonds/round.obj"};async function U0(){_n=new jh,new ig().load("./assets/env.hdr",function(s){s.mapping=ws,za=s,_n.environment=za,Ul(),Vo()}),Kn=new Ze(45,window.innerWidth/window.innerHeight,.1,1e3),Kn.position.set(0,2,5),dn=new K_({antialias:!0}),dn.setSize(window.innerWidth,window.innerHeight),dn.toneMapping=Fl,dn.outputEncoding=void 0,document.getElementsByClassName("canvas")[0].appendChild(dn.domElement);const t=await Ll(dn,"./assets/texture.jpg");_n.background=t;const e=new ff(16777215,1);e.position.set(5,10,5),_n.add(e);const n=new df(4210752);_n.add(n),Ba=new rg(Kn,dn.domElement),Ba.enableDamping=!0,window.addEventListener("resize",z0),document.getElementById("metalColor").addEventListener("change",F0),document.getElementById("carat").addEventListener("input",O0),document.getElementById("loadRingModel").addEventListener("click",()=>{Ul(),Vo()}),document.getElementById("diamondShape").addEventListener("change",s=>{Xn.diamondShape=s.target.value,Vo()}),Il=await Ll(dn,"./assets/diamond_envmap.jpg"),on={envMap:{value:Il},bvh:{value:new S0},bounces:{value:3},ior:{value:2.4},color:{value:new Lt(1,1,1)},correctMips:{value:!0},chromaticAberration:{value:!0},aberrationStrength:{value:.01},resolution:{value:new St(window.innerWidth,window.innerHeight)},projectionMatrixInv:{value:new kt},viewMatrixInv:{value:new kt}},Su=new Nn({uniforms:on,vertexShader:P0,fragmentShader:D0,side:an})}function Ul(){new hu().load("./assets/ring.obj",function(t){const e=new Qh({color:16777215,metalness:1,roughness:0,envMap:za,envMapIntensity:.5});t.traverse(function(n){n.isMesh&&(n.material=e)}),t.scale.set(.5,.5,.5),t.position.set(0,0,0),t.rotation.set(2,Math.PI/2,2),ki&&_n.remove(ki),ki=t,_n.add(ki)},void 0,function(t){console.error("Error loading ring model:",t)})}function N0(i){Wi&&(_n.remove(Wi),Wi=null),L0.load(I0[i],function(t){t.traverse(e=>{e.isMesh&&(e.geometry=e.geometry.toNonIndexed(),e.geometry.boundsTree=new tc(e.geometry,{lazyGeneration:!1,strategy:pu}),on.bvh.value.updateFrom(e.geometry.boundsTree),e.material=Su)}),t.scale.set(.5,.5,.5),t.position.set(7.5,0,0),t.rotation.set(180,Math.PI/100,80),_n.add(t),Wi=t},t=>{console.log(t.loaded/t.total*100+"% loaded")},t=>{console.error("An error happened",t)})}async function Vo(){N0(Xn.diamondShape)}function F0(){const i=document.getElementById("metalColor").value,t=B0(i);ki&&ki.traverse(function(e){e.isMesh&&e.material.color.set(t)})}function O0(){const i=document.getElementById("carat").value;if(Wi){const t=i/10;Wi.scale.set(t,t,t)}}function B0(i){return{white:16053492,rose:16761035,gold:16766720}[i]}function z0(){Kn.aspect=window.innerWidth/window.innerHeight,Kn.updateProjectionMatrix(),dn.setSize(window.innerWidth,window.innerHeight)}function Eu(){requestAnimationFrame(Eu),on.bounces.value=Xn.bounces,on.ior.value=Xn.ior,on.correctMips.value=Xn.correctMips,on.chromaticAberration.value=Xn.chromaticAberration,on.aberrationStrength.value=Xn.aberrationStrength,on.color.value.set(Xn.color),on.projectionMatrixInv.value.copy(Kn.projectionMatrixInverse),on.viewMatrixInv.value.copy(Kn.matrixWorld),Ba.update(),dn.render(_n,Kn)}await U0();Eu();
